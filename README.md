...
## Pages
- `index.html` — hero (3D core), about, highlights, featured projects, **AIDEN** AI assistant, CTA
- `projects.html` — all 6 projects + engineering journal gallery (click any image to enlarge)
...
- **JS** (vanilla, no frameworks):
  ...
  - `assistant.js` — **AIDEN**, the AI assistant. Runs fully client-side today (a knowledge base about you), so it works with zero backend and zero API keys.
